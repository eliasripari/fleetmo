...
export const HowItWorksProviders = ({ t }: { t: any }) => {
  // Dati degli step per providers
  const steps = [
    {
      number: "1",
      ...
      imageAlt: "Service Creation - Fleetmo",
      isReversed: false,
    },
    {
      number: "2",
      title: t("howItWorks.steps.assign.title"),
      description: t("howItWorks.steps.assign.description"),
      imageSrc: "/screens/aggiungi-autisti.png",
      imageAlt: "Supplier Assignment - Fleetmo",
      isReversed: true,
    },
    {
      number: "3",
      ...
      imageAlt: "Operation Monitoring - Fleetmo",
      isReversed: false,
    },
  ];
