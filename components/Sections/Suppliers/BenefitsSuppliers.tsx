...
import { Target, BarChart3, Settings, Route, ArrowRight } from "lucide-react";
...
export const BenefitsSuppliers = () => {
  ...
  const tools = [
    ...
    {
      id: "incoming",
      title: t("benefits.tools.incoming.title"),
      description: t("benefits.tools.incoming.description"),
      badge: t("benefits.tools.incoming.badge"),
      icon: BarChart3,
      joinWaitlist: t("benefits.tools.incoming.joinWaitlist"),
    },
    {
      id: "fleet",
      title: t("benefits.tools.fleet.title"),
      description: t("benefits.tools.fleet.description"),
      badge: t("benefits.tools.fleet.badge"),
      icon: Settings,
      joinWaitlist: t("benefits.tools.fleet.joinWaitlist"),
    },
    {
      id: "dashboard",
